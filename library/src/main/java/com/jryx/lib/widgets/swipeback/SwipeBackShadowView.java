package com.jryx.lib.widgets.swipeback;
...
class SwipeBackShadowView extends FrameLayout {
     ...
     * 阴影资源 id
     */
    private int mShadowResId = R.drawable.sliding_back_shadow;
    /**
     * 阴影区域的透明度是否根据滑动的距离渐变
     */
    ...
    void unBindPreActivity(boolean isNeedAddImageView) {
        ...
        if (mPreDecorView != null && mPreContentView != null) {
            ...
            mPreDecorView.addView(mPreContentView, 0,new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
